...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "i", function() { return /* reexport */ shared_esm_bundler["L" /* toDisplayString */]; });
...
__webpack_require__.d(__webpack_exports__, "d", function() { return /* reexport */ createElementBlock; });
__webpack_require__.d(__webpack_exports__, "e", function() { return /* reexport */ createBaseVNode; });
__webpack_require__.d(__webpack_exports__, "f", function() { return /* reexport */ defineComponent; });
...
function injectToKeepAliveRoot(hook, type, target, keepAliveRoot) {
    ...
    onUnmounted(() => {
        Object(shared_esm_bundler["K" /* remove */])(keepAliveRoot[type], injected);
    }, target);
}
...
function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
    ...
    if (Object(shared_esm_bundler["p" /* isFunction */])(ref)) {
        callWithErrorHandling(ref, owner, 12 /* FUNCTION_REF */, [value, refs]);
    }
    else {
        const _isString = Object(shared_esm_bundler["D" /* isString */])(ref);
        ...
        if (_isString || _isRef) {
            const doSet = () => {
                if (rawRef.f) {
                    ...
                    if (isUnmount) {
                        Object(shared_esm_bundler["o" /* isArray */])(existing) && Object(shared_esm_bundler["K" /* remove */])(existing, refValue);
                    }
                    else {
...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = shared_esm_bundler["b" /* EMPTY_OBJ */]) {
    ...
    return () => {
        ...
        if (instance && instance.scope) {
            Object(shared_esm_bundler["K" /* remove */])(instance.scope.effects, effect);
        }
    };
}
// this.$watch
